import { ScrollView, Platform, View, Text, TextInput, Keyboard, Modal } from "react-native";
...
export default function Register(): JSX.Element {
    ...
    const { formData, msg, setMsg, handleChange, changing, loading, sendRequest } =
        useSendRegisterForm(
            {
                fullname: "",
                username: "",
    ...
    return (
        ...
        >
            {showModal ? <EnterCodeModal showModal={showModal} inputStyle={inputStyle} /> : null}
            <Modal visible={loading} animationType="fade" transparent={true} style={{ flex: 1, justifyContent: "center", alignItems: "center" }} onRequestClose={() => {}} onShow={() => Keyboard.dismiss()} >
